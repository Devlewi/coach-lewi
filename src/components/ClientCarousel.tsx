...
function transformImageUrl(imageUrl: string): string {
  ...
  const options = {
    ...
    */
    ...
    responsive: {
      0: {
        items: 2, // Affiche 4 élément sur les petits écrans (mobiles)
      },
      600: {
        items: 3, // Affiche 2 éléments sur les tablettes
      },
      1000: {
          ...
          <div className="container">
            <div className="title-block text-center title-pd">
              ...
              {/* <p className="sub-title-client" style={{fontSize:15, lineHeight:2}}>
                Découvrez les cli avec lesquels nous avons travaillé.
              </p> */}
            </div>
