                  ...
                  <div className="topbar-home2">
                    ...
                    <div className="tb-social-lan language">
                      ...
                      <li>
                        ...
                        <li>
                          <a style={{color:"white", backgroundColor:"#37aae6", padding:10, borderRadius:3, opacity:1, fontWeight:700}} href="https://api.whatsapp.com/send/?phone=2250565110441&text&type=phone_number&app_absent=0" target="_blank">
                          <i className="fa fa-globe"></i>
                          &nbsp;
                            Besoin d&rsquo;un site ?
                          </a>
                        </li>
                        ...
                        <li>
                          <a
                            ...
                            target="_blank"
                          >
                            <i className="fab fa-facebook" aria-hidden="true" style={{fontSize:13}}/>
                          </a>
                        </li>
                        ...
                        <li>
                          <a
                            ...
                            target="_blank"
                          >
                            <i className="fab fa-whatsapp" aria-hidden="true" style={{fontSize:13}}/>
                          </a>
                        </li>
