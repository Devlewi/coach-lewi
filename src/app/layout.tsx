                ...
                <div className="col-md-12">
                  <div className="navi-warp-home-2">
                    <Link href="/" className="logo">
                      <Image
                        src="/images/logo-coach-lewi.png"
                        className="img-responsive"
                        alt="Image"
                        width={201} // Largeur de l'image
                        height={88} // Hauteur de l'image
                      />
                    </Link>
                    ...
                    <nav id="menu" className="hidden-lg" style={{ zIndex: 10 }}>
                      <ul>
                        ...
                        */}
                        ...
                        {/*
                        <li>
                          <Link href="/projets-en-vente">Projets en vente</Link>
                        </li>
                        */}
                        <li>
                          <Link href="/formations-video">Mes Formations Vidéos</Link>
                        </li>
                        <li>
                          <Link href="/mes-publications">Mon Blog</Link>
                        </li>
                    ...
                    <nav>
                      ...
                      <li className="activ">
                        ...
                        <li>
                        <Link href="/presentation">
                                <span className="lien">Présentation</span>
                              </Link>
                        </li>
                        */}
                        ...
                        <li>
                        <Link href="/ebooks">
                        <span className="lien">Mes E-Books</span>
                              </Link>
                              </li>
                        ...
                        */}
                        ...
                        <Link href="/mes-publications">
                                <span className="lien">Mon Blog</span>
                              </Link>
                        </li>                        
                        <li>
                          <Link href="/nous-contacter">Contact</Link>
                ...
                >
                  ...
                  <ul style={{ marginLeft: 20 }}>
                    ...
                    Array.isArray(blocfooterData) &&
                      ...
                      <p style={{marginLeft:-20}}>Aucun liens pour le moment !</p> // Affichage si aucun lien n'est disponible
                    )}
                  </ul>
                </div>
              </div>
