...
export const metadata: Metadata = {
  title: "Contactez-nous | Coach-Lewi.com – Assistance & Informations",
  description: "Besoin d’informations ou d’assistance ? Contactez Coach-Lewi.com pour toute question sur nos ressources éducatives, projets web et services. Nous sommes à votre écoute !",
  icons: {
