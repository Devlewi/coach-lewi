...
export const metadata: Metadata = {
  title: "Foire Aux Questions (FAQ) | Coach-Lewi.com",
  description: "Vous avez des questions ? Consultez notre Foire Aux Questions (FAQ) pour obtenir des réponses rapides sur nos services, formations et produits disponibles sur Coach-Lewi.com.",
  icons: {
            ...
            <div className="col-md-4">
              <div className="main-page">
                <Image
                  ...
                  alt="Faq COACH-LEWI" // Texte alternatif
